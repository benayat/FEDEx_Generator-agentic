...
class GroupBy(Operation.Operation):
    ...
    def explain(self, schema=None, attributes=None, top_k=TOP_K_DEFAULT, explainer='fedex', target=None, dir=None,
        ...
        if explainer == 'outlier':
            ...
            return measure.explain_outlier(res_col, self.source_df, self.group_attributes[0], agg_attr, agg_method, target, dir)
        if schema is None:
            schema = {}
